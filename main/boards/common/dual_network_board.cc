...
bool DualNetworkBoard::GetNetworkState(std::string &network_name, int &signal_quality, std::string &signal_quality_text)
{
    return current_board_->GetNetworkState(network_name, signal_quality, signal_quality_text);
}
