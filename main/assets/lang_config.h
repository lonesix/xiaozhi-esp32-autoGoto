...
namespace Lang {
    ...
    //     extern const char p3_tuichu_start[] asm("_binary_tuichu_p3_start");
    //     extern const char p3_tuichu_end[] asm("_binary_tuichu_p3_end");
    //     static const std::string_view P3_TUICHU {
    //     static_cast<const char*>(p3_tuichu_start),
    //     static_cast<size_t>(p3_tuichu_end - p3_tuichu_start)
    //     };
    ...
    //     static const std::string_view P3_WAKEUP {
    //     static_cast<const char*>(p3_wakeup_start),
    //     static_cast<size_t>(p3_wakeup_end - p3_wakeup_start)
    //     };
