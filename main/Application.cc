...
Application::Application()
    : boot_button_((gpio_num_t)1),//CONFIG_BOOT_BUTTON_GPIO
      volume_up_button_((gpio_num_t)0)//CONFIG_VOLUME_UP_BUTTON_GPIO
...
memset(minimax_content, 0, sizeof(minimax_content));
    ...
    // {
    if (!ws_client_->Connect(url.c_str())) {//url.c_str()
